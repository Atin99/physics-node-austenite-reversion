...
candidates = [
    os.path.join(_base, 'models', 'stage2_fixed_best.pt'),
    os.path.join(_base, 'models', 'final_best_stage2_fixed.pt'),
    os.path.join(_base, 'models', 'physics_node_best.pt'),
    os.path.join(_base, '..', 'models', 'v4_stage2_extended_best.pt'),
    os.path.join(_base, '..', 'models', 'v4_stage2_fixed_best.pt'),
    os.path.join(_base, '..', 'models', 'v43_hifi_stage2_best.pt'),
]
loaded = False
for p in candidates:
    if os.path.exists(p):
