...
if ckpt_path is None:
    raise FileNotFoundError(f"No checkpoint found. Searched: {[str(c) for c in _candidates]}")
...
# Save metrics to CSV
metrics_dir = Path(__file__).parent / 'docs'
metrics_dir.mkdir(parents=True, exist_ok=True)
metrics_path = metrics_dir / 'evaluation_metrics.csv'
