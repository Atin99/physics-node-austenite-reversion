...
try:
    ...
    tdb_path = next((p for p in [
        Path(__file__).parent / 'data' / 'calphad_tables' / 'FeMnC.tdb',
        Path(__file__).parent.parent / 'data' / 'calphad' / 'FeMnC.tdb',
    ] if p.exists()), Path(__file__).parent.parent / 'data' / 'calphad' / 'FeMnC.tdb')
